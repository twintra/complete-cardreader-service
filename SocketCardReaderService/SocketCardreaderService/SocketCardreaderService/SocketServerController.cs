...
namespace SocketCardreaderService
{
    ...
    {
        private readonly ThaiIDCard card;
        ...
        private void HandleClientMessage(String message)
        {
            ...
            else if (message == MessageCommands.IS_MONITORING)
            {
                ...
                SendMonitoringStatus(isMonitoringReader.ToString());
            }
            // functional command
        ...
        private Dictionary<String, dynamic> ReadPersonalData(bool withPhoto = true)
        {
            ...
            try
            {
                personal = card.readAll(withPhoto);
        ...
        public void SendMonitoringStatus(string status)
        {
            Console.WriteLine("==> SendStatus : {0}", status);
            SendMessageToClient(MessageUtil.MonitoringStatus(status));
        }
